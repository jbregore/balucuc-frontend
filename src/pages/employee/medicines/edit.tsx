...
const EmployeeHandoutEdit = () => {
  ...
  const handleHandoutMedicine = () => {
    alert("MEDICINE HANDOUT UPDATED SUCCESSFULLY");
    ...
    <div className="w-full min-h-[calc(100vh-157px)] bg-white rounded-md py-4 px-6 pt-8">
      ...
      {showConfirm && (
        <AddConfirmation
          ...
          title="Are you sure you want to update this handout medicine?"
        />
      )}
      {/*
...
EmployeeHandoutEdit.getLayout = getEmployeeLayout;
export default EmployeeHandoutEdit;
