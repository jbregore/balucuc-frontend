...
const EmployeeInfantsVaccinationRegister = () => {
  ...
  const handleRegisterInfant = () => {
    alert("INFANT REGISTERED SUCCESSFULLY");
    ...
    <div className="w-full min-h-[calc(100vh-157px)] bg-white rounded-md py-4 px-6 pt-8">
      <div className="w-[50%] mx-auto pb-2">
        <p className="text-[#525F7F] font-bold text-lg">
          Register Infants for Immunization
        </p>
      ...
      {showConfirm && (
        <AddConfirmation
          ...
          title="Are you sure you want to register this infant for immunization?"
        />
      )}
    </div>
  );
...
EmployeeInfantsVaccinationRegister.getLayout = getEmployeeLayout;
export default EmployeeInfantsVaccinationRegister;
